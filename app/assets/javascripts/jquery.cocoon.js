(function($) {
  ...
  $('.remove_fields.dynamic').live('click', function(e) {
    ...
    e.preventDefault();
    $this.closest(".nested-fields").addClass('deleted-suggestion').delay(2000).queue(function() { $(this).remove(); });
  ...
  $('.remove_fields.existing').live('click', function(e) {
    ...
    $this.closest(".nested-fields").addClass('deleted-suggestion').delay(2000).queue(function() { $(this).hide(); });
    trigger_after_removal_callback(trigger_node);
  });
