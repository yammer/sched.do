class FakeYammer < Sinatra::Base
  ...
  get '/api/v1/users/by_email.json' do
    ...
    if params[:email] == 'ralph@example.com'
  ...
  def json_for_user_id
     <<-JSON.strip_heredoc
      {"external_urls":[],"location":null,"network_name":"thoughtbot","stats":{"following":1,"updates":3,"followers":1},"state":"active","admin":"false","contact":{"phone_numbers":[],"im":{"provider":"","username":""},"email_addresses":[{"type":"primary","address":"bruce@example.com"}]},"type":"user","network_id":1,"last_name":"Wayne","settings":{"xdr_proxy":"https://xdrproxy.yammer.com"},"interests":null,"birth_date":"","significant_other":null,"previous_companies":[],"expertise":null,"mugshot_url":"https://mug0.assets-yammer.com/mugshot/images/48x48/no_photo.png","activated_at":"2012/07/12 23:09:00 +0000","name":"bruce","department":null,"hire_date":null,"guid":null,"kids_names":null,"timezone":"Pacific Time (US \u0026 Canada)","first_name":"Bruce","schools":[],"url":"https://www.yammer.com/api/v1/users/1488374236","verified_admin":"false","can_broadcast":"false","mugshot_url_template":"https://mug0.assets-yammer.com/mugshot/images/{width}x{height}/no_photo.png","network_domains":["thoughtbot.com"],"id":1488374236,"show_ask_for_photo":false,"full_name":"#{self.yammer_user_name}","web_url":"https://www.yammer.com/thoughtbot.com/users/bruce","summary":null,"job_title":"Developer"}
    JSON
  end
end
